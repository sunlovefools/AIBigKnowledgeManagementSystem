...
export function useDocuments(isModificationPanelOpen: boolean) {
    ...
    return {
        ...
        isLoadingMoreFiles: fileDomain.isLoadingMoreFiles,
        hasMoreFiles: fileDomain.hasMoreFiles,
        ...
        fetchFiles: fileDomain.fetchFiles,
        loadMoreFiles: fileDomain.loadMoreFiles,
        ...
        saveNotifications: editingDomain.saveNotifications,
        dismissSaveNotification: editingDomain.dismissSaveNotification,
        editingDocumentContent: editingDomain.editingDocumentContent,
        activeDocumentViewContent: editingDomain.getDocumentViewContent(fileDomain.activeTab),
        isFileSaving: editingDomain.isFileSaving,
