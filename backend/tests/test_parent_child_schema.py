...
def test_split_parent_child_chunks_outputs_new_schema():
    ...
    for child in child_chunks:
        ...
        assert set(payload.keys()) == {"child_chunk_id", "content", "file_metadata", "child_chunk_metadata"}
    ...
    for index, parent in enumerate(parent_chunks):
        ...
        assert set(payload.keys()) == {"parent_chunk_id", "content", "file_metadata", "parent_chunk_metadata"}
